    ...
    public class ColorsController : Controller
    {
        ...
        public ActionResult Index()
        {
          ...
          /*  var exampleList = new List<SelectListItem>();
            exampleList.Add(new SelectListItem { Text = "Red", Value = "1" });
            exampleList.Add(new SelectListItem { Text = "Black", Value = "2" });
            exampleList.Add(new SelectListItem { Text = "white", Value = "3" });
